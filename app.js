...
main()
    .then(() => {
        // console.log("connected to DB"); // handled inside main() now
    })
    .catch((err) => {
        console.log(err);
    });
...
app.use(express.json()); // Added to accept JSON
...
app.use((err, req, res, next) => {
    ...
    console.error("ERROR STACK:", err.stack); // ADDED THIS TO SEE THE ACTUAL ERROR
